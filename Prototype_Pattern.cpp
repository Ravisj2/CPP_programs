...
Prototype allows us to hide the complexity of making new instances from the client. In this sample, we used prototype manager to set the registry of concrete prototypes.
